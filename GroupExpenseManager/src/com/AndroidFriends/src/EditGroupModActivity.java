...
public class EditGroupModActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_edit_group_mod);
	...
	public void createToast(String message){
		Toast n = Toast.makeText(EditGroupModActivity.this,message, Toast.LENGTH_SHORT);
