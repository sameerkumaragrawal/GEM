...
public class NewGroupModActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_new_group_mod);
		commondb = CommonDatabase.get(this);

		adaptor = new ListAdaptor(this);
		items = new ArrayList<String>();

		list = (ListView) findViewById(R.id.newGroupListView_2);
	...
	public void done(View v) {
		...
		EditText editText = (EditText) (findViewById(R.id.newGroupeditText_2_1));
