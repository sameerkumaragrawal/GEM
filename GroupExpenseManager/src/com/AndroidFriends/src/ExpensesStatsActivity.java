...
public class ExpensesStatsActivity extends Activity {
    private TextView foodText, healthText, entertainmentText, travelText, shoppingText, accommodationText, billsText, miscellaneousText;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        angleValues = new float[8];
        percentageValues = new int[8];
        calculateData();
    ...
    private void setColours() {
    	...
    	miscellaneousText.setTextColor(BalanceActivity.COLORS[7]);
    }
    ...
    private void setValues() {
    	...
    	miscellaneousText.setText("Miscellaneous - " + percentageValues[7] + "%");
    }
